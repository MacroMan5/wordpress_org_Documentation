...
**Source URL:** [https://developer.wordpress.org/rest-api/extending-the-rest-api/modifying-responses/](https://developer.wordpress.org/rest-api/extending-the-rest-api/modifying-responses/)  
**Last Updated:** 2025-05-23T01:02:39.723Z  
...
## [Important Note about Changing Responses](#important-note-about-changing-responses)
...
## [Adding Custom Fields to API Responses](#adding-custom-fields-to-api-responses)

### [Using register\_rest\_field](#using-register_rest_field)
...
### [How register\_rest\_field Works](#how-register_rest_field-works)
...
### [Read and write a post meta field in post responses](#read-and-write-a-post-meta-field-in-post-responses)
...
### [Post Type Specific Meta](#post-type-specific-meta)
...
### [Object Meta Type](#object-meta-type)
...
### [Array Meta Type](#array-meta-type)
...
### [Non-Single Metadata](#non-single-metadata)
...
### [Invalid Stored Values](#invalid-stored-values)
...
## [Adding Links to the API Response](#adding-links-to-the-api-response)
...
### [Registering a CURIE](#registering-a-curie)
...
This will convert link URLs from ``https://api.mypluginurl.com/my_link` to``my\_plugin:my\_link`in the API response. The full URL must still be used when adding links using`[WP\_REST\_Response::add\_link()](https://developer.wordpress.org/reference/classes/wp_rest_response/add_link/) \`.
