# Navigations – REST API Handbook | Developer.WordPress.org

**Source URL:** [https://developer.wordpress.org/rest-api/reference/wp_navigations/](https://developer.wordpress.org/rest-api/reference/wp_navigations/)  
**Last Updated:** 2025-05-23T01:01:23.168Z  
**Extracted:** 2025-05-31 16:56:23

---

# Navigations – REST API Handbook
...
| `status` | A named status for the post.<br><br>JSON data type: string<br><br>Context: `view`, `edit`, `embed`<br><br>One of: `publish`, `future`, `draft`, `pending`, `private` |
