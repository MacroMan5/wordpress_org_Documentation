# Template_Parts – REST API Handbook | Developer.WordPress.org

**Source URL:** [https://developer.wordpress.org/rest-api/reference/wp_template_parts/](https://developer.wordpress.org/rest-api/reference/wp_template_parts/)  
**Last Updated:** 2025-05-23T01:03:14.225Z  
**Extracted:** 2025-05-31 16:56:23

---

# Template\_Parts – REST API Handbook
...
| `area` | Where the template part is intended for use (header, footer, etc.)<br><br>JSON data type: string<br><br>Context: `embed`, `view`, `edit` |

## [Retrieve a Template\_Part](#retrieve-a-template_part)
