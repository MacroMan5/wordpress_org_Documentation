# Common issues – Plugin Handbook | Developer.WordPress.org

**Source URL:** [https://developer.wordpress.org/plugins/wordpress-org/common-issues/](https://developer.wordpress.org/plugins/wordpress-org/common-issues/)  
**Last Updated:** 2025-05-24T13:46:55.285Z  
**Extracted:** 2025-05-31 16:56:23

---

# Common issues – Plugin Handbook
...
### [Processing the whole input](#processing-the-whole-input)
...
WordPress includes a list of safe files, as you can see in the function [wp\_get\_mime\_types](https://developer.wordpress.org/reference/functions/wp_get_mime_types).
...
### [WPDB: Unsafe SQL calls](#wpdb-unsafe-sql-calls)
...
### [Not use HEREDOC-NOWDOC](#not-use-heredoc-nowdoc)
...
### [Use wp\_enqueue commands](#use-wp_enqueue-commands)
...
### [Including Libraries Already In Core](#including-libraries-already-in-core)
...
### [Changing Active Plugins](#changing-active-plugins)
...
### [Undocumented 3rd party](#undocumented-3rd-party)
...
### [Included Unneeded Folders](#included-unneeded-folders)
...
### [Not permitted files](#not-permitted-files)
